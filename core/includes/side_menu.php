			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li>
					...
					<ul class="nav nav-second-level collapse">
						<li><a href="add_stock_details.php"> Add Stock Details</a></li>
						<li><a href="view_stock_details.php"> View Stock Details</a></li>
						<li><a href="add_purchase.php">Purchase Stock </a></li>
						<li><a href="view_stock_entries.php"> View Purchase</a></li>
						<li><a href="view_stock_availability.php"> View Stock Availibility</a></li>
					</ul>
				</li>
			</ul>
