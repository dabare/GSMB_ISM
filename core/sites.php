...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-8">
                        <h2>Sites informations</h2>
                        <ol class="breadcrumb">
                            <li>
                                <a href="index.php">Home</a>
                            </li>
                            <li class="active">
                                <strong>Sites informations</strong>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row">
                                                        ...
                                                        <table class="table table-striped table-hover">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a data-toggle="tab" href="#depcontact-1" class="client-link">Anthony Jackson</a></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a data-toggle="tab" href="#depcontact-2" class="client-link">Rooney Lindsay</a></td>
                                                                    <td>Proin Limited</td>
                                                                    <td class="contact-type"><i class="fa fa-envelope"> </i></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a data-toggle="tab" href="#depcontact-1" class="client-link">Lionel Mcmillan</a></td>
                                                                    <td>Et Industries</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a data-toggle="tab" href="#depcontact-2" class="client-link">Edan Randall</a></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a data-toggle="tab" href="#depcontact-1" class="client-link">Jasper Carson</a></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a data-toggle="tab" href="#depcontact-2" class="client-link">Reuben Pacheco</a></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a data-toggle="tab" href="#depcontact-1" class="client-link">Simon Carson</a></td>
                                                                    <td>Erat Corp.</td>
                                                                    <td class="contact-type"><i class="fa fa-envelope"> </i></td>
                                                                ...
                                                                <tr>
                                                                    <td class="client-avatar"><a href="#"><img alt="image" src="img/a5.jpg"></a> </td>
                                                                    <td><a data-toggle="tab" href="#depcontact-1" class="client-link">Edan Randall</a></td>
                                                                    <td>Integer Sem Corp.</td>
                                                                    <td class="contact-type"><i class="fa fa-phone"> </i></td>
                                                                    <td> +422 600 213</td>
                                                                    <td class="client-status"><span class="label label-info">Phoned</span></td>
                                                                ...
                                                                <tr>
                                                                    <td class="client-avatar"><a href="#"><img alt="image" src="img/a6.jpg"></a> </td>
                                                                    <td><a data-toggle="tab" href="#depcontact-2" class="client-link">Jasper Carson</a></td>
                                                                    <td>Mone Industries</td>
                                                                    <td class="contact-type"><i class="fa fa-phone"> </i></td>
                                                                    <td> +400 468 921</td>
                                                                    <td class="client-status"><span class="label label-primary">Active</span></td>
                                                                ...
                                                                <tr>
                                                                    <td class="client-avatar"><a href="#"><img alt="image" src="img/a7.jpg"></a> </td>
                                                                    <td><a data-toggle="tab" href="#depcontact-1" class="client-link">Reuben Pacheco</a></td>
                                                                    <td>Magna Associates</td>
                                                                    <td class="contact-type"><i class="fa fa-envelope"> </i></td>
                                                                    <td> pacheco@manga.com</td>
                                                                    <td class="client-status"><span class="label label-primary">Active</span></td>
                                                                ...
                                                                <tr>
                                                                    <td class="client-avatar"><a href="#"><img alt="image" src="img/a1.jpg"></a> </td>
                                                                    <td><a data-toggle="tab" href="#depcontact-2" class="client-link">Simon Carson</a></td>
                                                                    <td>Erat Corp.</td>
                                                                    <td class="contact-type"><i class="fa fa-envelope"> </i></td>
                                                                    <td> Simon@erta.com</td>
                                                                    <td class="client-status"></td>
                                                                ...
                                                                <tr>
                                                                    <td class="client-avatar"><a href="#"><img alt="image" src="img/a3.jpg"></a> </td>
                                                                    <td><a data-toggle="tab" href="#depcontact-1" class="client-link">Rooney Lindsay</a></td>
                                                                    <td>Proin Limited</td>
                                                                    <td class="contact-type"><i class="fa fa-envelope"> </i></td>
                                                                    <td> rooney@proin.com</td>
                                                                    <td class="client-status"></td>
                                                                ...
                                                                <tr>
                                                                    <td class="client-avatar"><a href="#"><img alt="image" src="img/a4.jpg"></a> </td>
                                                                    <td><a data-toggle="tab" href="#depcontact-2" class="client-link">Lionel Mcmillan</a></td>
                                                                    <td>Et Industries</td>
                                                                    <td class="contact-type"><i class="fa fa-phone"> </i></td>
                                                                    <td> +432 955 908</td>
                                                                    <td class="client-status"><span class="label label-primary">Active</span></td>
                        ...
                        <div class="col-sm-4">
                            <div class="ibox">
                                <div class="ibox-content">
                                    <div class="tab-content">
                                        <div id="depcontact-1" class="tab-pane active">
                                            <h2>Departments1</h2>
                                        ...
                                        <div id="depcontact-2" class="tab-pane active">
                                            <h2>Departments1</h2>
        ...
        <script>
            document.getElementById("sites").setAttribute("class", "active");
        </script>
    </body>
